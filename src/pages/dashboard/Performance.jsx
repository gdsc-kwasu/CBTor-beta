...
const Performance = () => {
  return (
    <section id="perfromance-root" className="pb-1">
      <div className="flex-column col-sm-12">
        <div className="d-flex performance-cards">
          {performance.map((test, index) => {
            return (
              <div
                className="col-sm-12 col-md-3 shadow py-1 bg-white card rounded"
                key={index}
              >
        ...
        <div className="performance-table">
          <table className="mt-4 shadow bg-white table">
