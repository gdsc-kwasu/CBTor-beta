...
const Wallet = () => {
  ...
  return (
    <section className="d-center">
      <div className="col-sm-12 col-md-10 shadow vh-100 d-center flex-column bg-white">
        <p className="text-center pb-3">My wallet balance</p>
        ...
        <p className="text-dark-50 py-4 col-sm-10 text-center small px-5">
